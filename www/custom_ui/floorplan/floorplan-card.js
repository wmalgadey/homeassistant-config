class FloorplanCard extends HTMLElement {
  ...
  loadScripts() {
    ...
    promises.push(this.loadScript(`/local/custom_ui/floorplan/lib/floorplan.js?v=${this.version}`, true));
    promises.push(this.loadScript('/local/custom_ui/floorplan/lib/yaml.min.js', true));
    promises.push(this.loadScript('/local/custom_ui/floorplan/lib/jquery-3.4.1.min.js', true));
